...
(function() {
  ...
  GameOfLife = (function() {
    GameOfLife.prototype.size = 15;

    GameOfLife.prototype.nocells = 50;
    ...
    GameOfLife.prototype.makeCanvas = function() {
      ...
      this.canvas.height = this.nocells * this.size + this.nocells;
      return this.canvas.width = this.nocells * this.size + this.nocells;
    };
    ...
    GameOfLife.prototype.tick = function() {
      ...
      this.changeState();
      this.updateSquare();
      return setTimeout(this.tick, this.ticktime);
    };
